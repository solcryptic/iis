...
const Pricing = () => {
  ...
  const [IphoneX, Iphone11, Iphone12, Iphone13, Iphone14] = items;
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* <ul className={`w-full text-center text-sm`}>
                {IphoneX?.features.map((feature) => (
                  <li
                    className={`border-b py-4`}
                    key={`${IphoneX?.name}-${feature}`}
                  >
                    {feature}
                  </li>
                ))}
            ...
            >
              ...
              >
                {IphoneX?.price}
                <span className={`text-base`}> {IphoneX?.priceDetails}</span>
              </div>
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              ...
              {/* <ul className={`w-full text-center text-sm`}>
                {Iphone11?.features.map((feature) => (
                  <li
                    className={`border-b py-4`}
                    key={`${Iphone11?.name}-${feature}`}
                  >
                    {feature}
                  </li>
                ))}
            ...
            >
              ...
              >
                {Iphone11?.price}
                <span className={`text-base`}> {Iphone11?.priceDetails}</span>
              </div>
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              ...
              >
                {Iphone12?.price}
                <span className={`text-base`}> {Iphone12?.priceDetails}</span>
              </div>
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              ...
              {/* <ul className={`w-full text-center text-sm`}>
                {Iphone13?.features.map((feature) => (
                  <li
                    className={`border-b py-4`}
                    key={`${Iphone13?.name}-${feature}`}
                  >
                    {feature}
                  </li>
                ))}
            ...
            >
              ...
              >
                {Iphone13?.price}
                <span className={`text-base`}> {Iphone13?.priceDetails}</span>
              </div>
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              ...
              {/* <ul className={`w-full text-center text-sm`}>
                {Iphone14?.features.map((feature) => (
                  <li
                    className={`border-b py-4`}
                    key={`${Iphone14?.name}-${feature}`}
                  >
                    {feature}
                  </li>
                ))}
            ...
            >
              ...
              >
                {Iphone14?.price}
                <span className={`text-base`}> {Iphone14?.priceDetails}</span>
              </div>
            </div>
          </div>
        </div>
